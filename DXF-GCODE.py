...
#  Turns ony lines into machining moves (not polylines or arcs or circles etc.)
#  Drills holes through all circles smaller than set radius.
#
#  
#  Copyright 2018 Richard Creese
#  
...
OPENFILEPATH="./Drawing/360SXiiS.dxf"
SAVEFILE = "./home/hamza.txt"
SAFEHEIGHT 	= "10"
SKIMHEIGHT  = "3"
STARTHEIGHT = "1"
CUTDEPTH    = "-0.15"
...
print ("Circles bigger then R" + str(CIRCLERAD) + " found " , BIGCOUNT)
